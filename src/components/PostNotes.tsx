          ...
          {popover.mode === "add-note" && (
            <>
              ...
              <div className="px-3 pb-3 flex gap-2">
                ...
                <button
                  onClick={() => setPopover((p) => p ? { ...p, mode: "confirm-delete" } : null)}
                  className="flex items-center justify-center gap-1 px-2.5 py-1.5 rounded-md border border-border text-xs hover:bg-muted hover:text-destructive transition-colors"
                >
